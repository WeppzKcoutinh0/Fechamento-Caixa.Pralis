...
SELECT
    ...
    GROUP_CONCAT(DISTINCT vb.ID_VENDA_BALCAO ORDER BY vb.ID_VENDA_BALCAO SEPARATOR ', ') AS IDS_VENDA_CREARE,
    GROUP_CONCAT(DISTINCT fp.DESCRICAO ORDER BY fp.DESCRICAO SEPARATOR ', ') AS FORMAS_PAGAMENTO,
...
LEFT JOIN formapgto_venda_balcao fvb
    ON fvb.ID_VENDA_BALCAO = ivb.ID_VENDA_BALCAO
