-- Corrige: `jsonb_populate_record` não aplica defaults de coluna, então `criado_em`/
-- `atualizado_em` chegavam nulos e violavam a constraint NOT NULL. Preenche explicitamente.
