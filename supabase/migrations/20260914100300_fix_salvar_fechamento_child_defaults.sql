-- Mesmo problema (jsonb_populate_record/extração de jsonb não aplica defaults de coluna),
-- agora corrigido também nas 5 tabelas filhas: entradas, sangrias, lancamentos,
-- discriminacoes, crediario_itens.
