-- Atualiza salvar_fechamento pra gravar a coluna nova de lancamentos (20260916190000). Base:
-- a versão de 20260915150000 (pdv_entradas) — só a lista de colunas do insert de lancamentos muda.
