-- Detalhes por bandeira/modalidade lidos do relatório da maquininha.
alter table public.fechamentos
  add column if not exists detalhes_maquininha_manha jsonb not null default '{}'::jsonb,
  add column if not exists detalhes_maquininha_tarde jsonb not null default '{}'::jsonb;
